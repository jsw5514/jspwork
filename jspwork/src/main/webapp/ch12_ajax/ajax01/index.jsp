...
-->	  
	...
	<h3>3. 서버에 데이터 전송 후, 조회된 데이터를 bean 객체로 응답</h3>
    
    검색하고자 하는 회원 ID : <input id="inputId">
    <input type="button" id="btn3" value="조회"><br>
                ...
                success:function(result) {
                    ...
                    if(result.status == "fail") {
                        ...
                        const value = "********** 검색 결과 *************<br>" +
                            ...
                            // "email: " + result.email
                            //gson을 사용하여 데이터를 map에 넣은 경우
                            "ID: " + result.member.id + "<br>" +
                            "name: " + result.member.name + "<br>" +
                            "gender: " + result.member.gender + "<br>" +
	...
	<h3>4. 응답데이터로 조회된 여러 bean 객체들이 담겨있는 ArrayList 받기</h3>
	
    <input type="button" id="btn4" value="확인용">
	<table id="output4">
        <thead>
            <tr>
                <th>id</th>
